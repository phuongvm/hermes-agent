...
def verify_jwt(
    token: str, jwks_client: Any, *, algorithms: list[str], audience: str, issuer: str, label: str, leeway: int = 0) -> Dict[str, Any]:
    ...
    try:
        return jwt.decode(
            ...
            options={"require": ["exp", "iat", "aud", "iss", "sub"]}, leeway=leeway)
