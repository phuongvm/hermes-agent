...
class TestDoctorPlatformHints:
    ...
    def test_package_hint_on_win32(self, monkeypatch):
        ...
        assert doctor_platform._system_package_install_cmd("ripgrep") == "winget install BurntSushi.ripgrep.MSVC"
        assert doctor_platform._system_package_install_cmd("other") == "winget install other"
