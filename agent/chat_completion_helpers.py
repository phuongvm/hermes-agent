        ...
        try:
            ...
            try:
                ...
                if task_id:
                    ...
                    record_task_identity_event(task_id, {
                        "effective_model": fb_model, "effective_provider": fb_provider,
                        "reason": reason.value if hasattr(reason, "value") else str(reason),
                    }, "fallback_activated")
            except Exception as event_error:
                logger.warning("Could not record fallback identity event: %s", event_error)
