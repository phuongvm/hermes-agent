...
def kanban_command(args: argparse.Namespace) -> int:
    ...
    with board_scope:
        ...
        handler = {"openspec-activate": _cmd_openspec_activate, "openspec-rollback": _cmd_openspec_rollback}.get(action) or _HANDLERS.get(action)
        if not handler:
...
_DELEGATED_CHILD_DENIED_ACTIONS: frozenset[str] = frozenset({
    "openspec-activate", "openspec-rollback", "init", "create", "swarm", "assign", "reclaim", "reassign", "link", "unlink",
