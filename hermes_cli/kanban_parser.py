...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    commands = kanban_parser.add_subparsers(dest="kanban_action")
    _add_commands(commands, _SPECS)
    activate = commands.add_parser("openspec-activate", help="Activate OpenSpec enforcement")
    activate.add_argument("operator")
    commands.add_parser("openspec-rollback", help="Roll back OpenSpec enforcement")
